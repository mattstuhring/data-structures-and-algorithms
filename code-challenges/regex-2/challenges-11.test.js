...
const validateEmail = (email) => {
  return /^\w+([\.-]?\w+)@\w+([\.-]?\w+)*(\.[.net\$ | .com\$ | .org\$]{2,3})+$/.test(email);
};
...
const validatePhoneNumber = (phoneNumber) => {
  return phoneNumber.match(/^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|extension)\s*(\d+))?$/);
};
